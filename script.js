...
<div class="card col-12 col-md-2 p-3 my-3 my-md-4"
        ...
        <img src="https://imgv3.fotor.com/images/blog-cover-image/part-blurry-image.jpg" class="card-img-top rounded-3"
          alt="..." />
        <div class="card-body p-0">
          ...
          <div class="container-fluid mt-3 d-flex justify-content-between">
            <div>
              <h1 class="fs-4 fw-semibold mb-2">ChatGPT</h1>
              <div class="d-flex">
                ...
                <span class="align-self-center">11/01/2022</span>
              </div>
            </div>
            <div class="align-self-center">
              <button type="button" class="btn rounded-circle btn-outline-none" data-bs-toggle="modal" data-bs-target="#detailsModal"
